...
const summaryValues = [
  { period: { label: 'Ventas del dia', value: 500 } },
  { period: { label: 'Ventas de la semana', value: 1200 } },
]
        ...
        <Card className="h-[500px]">
          <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
            <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-3 sm:py-3">
              ...
              <CardDescription>Mostrando ventas de los últimos 3 meses</CardDescription>
            </div>
            <div className="flex">
